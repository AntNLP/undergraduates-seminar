...
class SoftmaxModel(Model):
    ...
    def create_feed_dict(self, inputs_batch, labels_batch=None):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = dy.inputTensor(inputs_batch, True)

        self.labels_placeholder = dy.inputTensor(labels_batch, True)
        ### END YOUR CODE
        return feed_dict
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        loss = cross_entropy_loss(pred, self.labels)
        ### END YOUR CODE
        return loss
